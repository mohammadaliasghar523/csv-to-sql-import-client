		...
		return (
			<div className="wrapper">
					...
					<div className="container">
						...
						<p>
							<i
								...
								style={{ color: "  #e6b800" }}
							/>
							CSV/XLSX file of Tip data should be like :
							<a
								href="https://github.com/krishankantray/temp/blob/master/test.csv"
								target="_blank"
							>
								Sample file
							</a>
							...
							<i
								...
								style={{ color: " #e6b800" }}
							/>
							"id" column is Primary Key in the MySQL table ( i.e. duplicates ID
							not allowed )
						</p>
					</div>
				</div>
				...
				<div className="section3">
					{this.state.showTable && <Table tabledata={this.state.tabledata} />}
				</div>
			</div>
		);
	}
